...
main:
  ...
  beqz $8, exit			# If width == 0, terminate the program
  ...
  mflo	$10				# bring the product into $10 (assume hi not needed)
				...
				# Calculating the Perimeter, stored in $t3
  addi $t3, $t0, 0			# Clearing $t3
  add $t3, $8, $8			# Adding width * 2 into the perimeter calculation
  add $t3, $t3, $9			# Adding height into the perimeter calculation
  add $t3, $t3, $9			# Adding height into the perimeter calculation
  ...
  addi $v0, $0, 1			# system call 1 for printing an integer
  add $a0, $0, $t3			# bring the perimeter value from $t3 to $a0
  syscall				#print the integer
  ...
  j main			# Loop: Jump to main label to go through steps again...
